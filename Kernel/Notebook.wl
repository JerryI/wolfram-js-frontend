...
NotebookHEAD := JerryI`WolframJSFrontend`head
NotebookHEAD /: Set[NotebookHEAD, HEAD_String] := (NotebookHEAD := HEAD; Put[HEAD, FileNameJoin[{JerryI`WolframJSFrontend`root, ".shead"}]])
