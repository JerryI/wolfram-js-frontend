...
,0.7660444431189781,-0.6427876096865393]]", "date" -> 
        DateObject[{2023, 6, 19, 15, 56, 24.962043`8.149855109590487}, 
         "Instant", "Gregorian", 3.]|>, 
...
ts'\"]]],[\"Rule\",\"ImageSize\",[\"List\",400,420]]]", 
     ...
     "a2bac611-284b-4498-a151-1becb735424b" -> 
      <|"json" -> "[\"RangeView\",[\"List\",-1,1,0.1,0.0],[\"Rule\",\"'Event'\
\",\"'904f0a07-b963-45b8-945d-a0685cb8b49b'\"],[\"Rule\",\"'Label'\",\"'Lengt\
h'\"]]", "date" -> DateObject[{2023, 6, 19, 15, 57, 
          16.62681`7.97338391878456}, "Instant", "Gregorian", 3.]|>, 
...
object generator", "display" -> "markdown", "sign" -> "relaxant-595cc", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "49ee0b4c-babc-43e8-9d3c-b9bff41864f3ab0", "type" -> "input", 
...
\"TransitionDuration\"->300, \"TransitionType\"->\"Linear\"] ", 
   ...
   <|"id" -> "852a4178-9e72-459f-82c9-aee935eb551eab0", "type" -> "input", 
    ...
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "0edb8af8-ff67-4b18-829d-5c3d1769e476ab0", "type" -> "input", 
...
like in Mathematica", "display" -> "markdown", "sign" -> "relaxant-595cc", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "0f50a013-3db8-4b2f-85b7-9ea2db0d8028ab0", "type" -> "input", 
    "data" -> "dot = {{0,0}, {0.5,0.5}};\nGraphics[{\n  Red, PointSize[0.1], \
\n  EventHandler[Point[{{0.5,0.5}}], { \"drag\" -> Function[p, dot = {{0,0}, \
