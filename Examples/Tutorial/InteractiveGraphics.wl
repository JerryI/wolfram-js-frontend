...
EndRef\",\"'dot'\"]]]]", "date" -> DateObject[{2023, 5, 27, 18, 44, 
     ...
     "2cc64611-69b9-4b29-a326-45605ce59b6f" -> 
      <|"json" -> "[\"Graphics\",[\"List\",[\"RGBColor\",1,0,0],[\"PointSize\
\",0.1],[\"EventListener\",[\"Point\",[\"List\",[\"List\",0.5,0.5]]],[\"Rule\
...
event-listener attached to a graphical object", "display" -> "codemirror", 
    "sign" -> "acceptor-5a8e4", "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "60d2ae20-b4aa-4a5d-8f49-abb00c1fd2d3ca0795", 
    "type" -> "output", "data" -> "\n# Interactive graphics\nSimple \
event-listener attached to a graphical object", "display" -> "markdown", 
    "sign" -> "acceptor-5a8e4", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "7988df20-024e-485d-a369-abb20a73a08d795", "type" -> "input", 
    "data" -> 
     ".md\n__High-level implementation__\n\nAs it is. When a symbol is held", 
    "display" -> "codemirror", "sign" -> "acceptor-5a8e4", 
    "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "faf18f43-86f3-4233-b458-85e4141039cb795", "type" -> "output", 
    "data" -> 
     "\n__High-level implementation__\n\nAs it is. When a symbol is held", 
    "display" -> "markdown", "sign" -> "acceptor-5a8e4", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "98d7f48c-bd71-4da5-b3e4-816a0104515fca0795", "type" -> "input", 
    "data" -> "p = {0.5,0.5};\n\nGraphics[{\n  Red, PointSize[0.1], \n  \
...
Line[{{0,0}, Hold[p]}]\n}]", "display" -> "codemirror", 
   ...
   <|"id" -> "6a440740-baad-476b-8ed7-cec48cf46fc6795", "type" -> "input", 
    "data" -> ".md\n__Low-level implementation__\n\nUsing frontend objects", 
    "display" -> "codemirror", "sign" -> "acceptor-5a8e4", 
    "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "ca9e684a-661a-422c-839e-370ba63d3270795", "type" -> "output", 
    "data" -> "\n__Low-level implementation__\n\nUsing frontend objects", 
    "display" -> "markdown", "sign" -> "acceptor-5a8e4", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "2c3e7b5f-7cd5-4804-b9c1-20612376bee4795", "type" -> "input", 
