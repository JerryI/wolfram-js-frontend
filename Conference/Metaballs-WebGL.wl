<|"notebook" -> <|"name" -> "Untitled", "id" -> "schooling-73ab9", 
...
fram-js-frontend/Conference/Metaballs-WebGL.wl", 
   "cell" -> "c97fcaff-e58a-4bc3-9a6c-9ef5e920fddf711de4", 
   "date" -> DateObject[{2023, 5, 29, 11, 23, 41.201847`8.367491663037608}, 
     "Instant", "Gregorian", 2.]|>, 
 "cells" -> {<|"id" -> "c97fcaff-e58a-4bc3-9a6c-9ef5e920fddf711de44fa", 
...
system.\nThe overall diagram is shown here", "display" -> "codemirror", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "3617905c-9eda-407d-baf2-15e4ada2349f4fa", "type" -> "output", 
    "data" -> "\n# WebGL Metaballs example\nShow some demonstration on how \
WebGL can interact with WL Kernel using event-based system.\nThe overall \
diagram is shown here", "display" -> "markdown", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "35991874-457f-4b48-95ad-c71f02cac5b3711de44fa", 
...
H--->Calculations[/Calculations/]--WebSockets-->definedFunction", 
    "display" -> "codemirror", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "c9e386ec-7dbe-45bf-b99a-d679e24313354fa", "type" -> "output", 
...
--> API\n        API -- each frame --> event\n        subgraph WebGL\n        \
    API\n        end\n\n    end\n    \n\n    \
H--->Calculations[/Calculations/]--WebSockets-->definedFunction", 
    "display" -> "mermaid", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "3c35153e-9feb-4714-9e27-b4f009b59a6a711de44fa", 
    "type" -> "input", "data" -> ".md\nEverything goes asynchronous, \
therefore, you can still operate with the cells. \n\nLet's define some basic \
3-bodies system", "display" -> "codemirror", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "2db05a20-3369-4f26-8305-f37497e7899f4fa", "type" -> "output", 
    "data" -> "\nEverything goes asynchronous, therefore, you can still \
operate with the cells. \n\nLet's define some basic 3-bodies system", 
    "display" -> "markdown", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "ccb4a456-c63f-4fc3-bd62-648a00a34c40711de44fa", 
...
EventObject[<|\"id\"->\"reCompute\"|>];\nupdate", "display" -> "codemirror", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "7ccd996c-2df7-4a87-a0f2-8082f2b495a9", "type" -> "output", 
    "data" -> "EventObject[\[LeftAssociation]\"id\"\[Rule]\"reCompute\"\
\[RightAssociation]]", "display" -> "codemirror", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "70ecb26b-e336-4e13-baeb-11299bc68b31711de44fa", 
    "type" -> "input", "data" -> ".md\nNow JS part comes with some basic \
shaders, which returns a DOM element", "display" -> "codemirror", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "80799720-ae3d-4fc1-ba72-9302e5d62f064fa", "type" -> "output", 
    "data" -> "\nNow JS part comes with some basic shaders, which returns a \
DOM element", "display" -> "markdown", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "83ff519e-72a1-4539-a9a0-7a9673c7255f711de44fa", 
    "type" -> "input", "data" -> ".js\nconst canvas = \
...
{cancelAnimationFrame(uid)};\n\nreturn canvas;", "display" -> "codemirror", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "8f469c69-8f7b-4e2e-a471-3b6b2e915c5e", "type" -> "output", 
...
{cancelAnimationFrame(uid)};\n\nreturn canvas;", "display" -> "js", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "9d549d1e-2030-4b8f-bc8c-0578c53bb9aa711de44fa", 
    "type" -> "input", "data" -> ".md\nStop the simulation", 
    "display" -> "codemirror", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "5bde2720-057a-4cb4-9397-1052ace25af34fa", "type" -> "output", 
    "data" -> "\nStop the simulation", "display" -> "markdown", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "5e95ca4a-722c-4578-8ab8-3514135ec9ab711de44fa", 
    "type" -> "input", "data" -> "EventRemove[update];", 
    "display" -> "codemirror", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "18f5b016-d199-4e17-8874-b975b7b09154711de44fa", 
    "type" -> "input", "data" -> ".md\nStart the simulation", 
    "display" -> "codemirror", "sign" -> "schooling-73ab9", 
    "props" -> <|"hidden" -> True|>|>, 
   <|"id" -> "0e320349-8df3-45dc-959d-9666f64932234fa", "type" -> "output", 
    "data" -> "\nStart the simulation", "display" -> "markdown", 
    "sign" -> "schooling-73ab9", "props" -> <|"hidden" -> False|>|>, 
   <|"id" -> "12b8b86d-9687-464d-9c3f-79e50605395e711de44fa", 
