Since the interpretation on the output cells happends in JS, then we can pack all data into an `.html` file and easily share it with other people by clicking `Share`. There are a few options
